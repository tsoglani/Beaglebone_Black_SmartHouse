...
public class TimerView extends JPanel
{
    ...
    public TimerView(Fr fr)
    {
        ...
        ImageIcon addTime=new ImageIcon(SH.contentPath+"add_timer.png");
        ...
        ImageIcon deleteIcon=new ImageIcon(SH.contentPath+"trash.png");
        deleteIcon=new ImageIcon(fr.getScaledImage(deleteIcon.getImage(),(int)(fr.height/15), (int)(fr.height/15)));
        deleteButton = new JButton(deleteIcon);
        bottomPanel.setLayout(new GridLayout(1,3));

        ImageIcon cancelIcon=new ImageIcon(SH.contentPath+"cancel3.png");
