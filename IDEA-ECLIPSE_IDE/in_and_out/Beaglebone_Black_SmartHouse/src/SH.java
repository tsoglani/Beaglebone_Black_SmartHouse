...
import io.silverspoon.bulldog.beagleboneblack.BeagleBoneBlack;
...
// on addCommandsAndPorts function RECOMENDER LOWER CASE TEXT
    ...
    final  Pin[]  inputString= {
            Pin.P8_07,   Pin.P8_08,   Pin.P8_09,   Pin.P8_10,   Pin.P8_11,   Pin.P8_12,     Pin.P8_14,
            Pin.P8_15,   Pin.P8_16,   Pin.P8_17,   Pin.P8_18,       Pin.P8_26,
             Pin.P8_33, Pin.P8_35,    Pin.P9_24, Pin.P9_26,
             Pin. P9_37, Pin. P9_39,Pin.P8_38B,
            Pin.P9_19B,  Pin.P9_20B,Pin.P9_40,Pin.P9_41B,Pin.P9_42B


    };
    final  String[] outputString = {
            //Pin.P8_03,   Pin.P8_04,   Pin.P8_05,   Pin.P8_06,  Pin.P8_20,   Pin.P8_21,   Pin.P8_22,   Pin.P8_23,   Pin.P8_24,   Pin.P8_25,     Pin.P8_27, Pin.P8_28, Pin.P8_29, Pin.P8_30, Pin.P8_31, Pin.P8_32, Pin.P8_34
            BBBNames.P8_36, BBBNames.P8_37, BBBNames.P8_38, BBBNames.P8_39,BBBNames.P8_40,
            BBBNames.P8_41, BBBNames.P8_42, BBBNames.P8_43, BBBNames.P8_44, BBBNames.P8_45,
            BBBNames.P8_46, BBBNames.P9_14, BBBNames.P9_15,BBBNames.P9_16, BBBNames.P9_17,
            BBBNames.P9_18,  BBBNames.P9_19,   BBBNames.P9_21,  BBBNames.P9_22,
            BBBNames.P9_23,   BBBNames.P9_27, BBBNames.P9_28
            ,BBBNames.P9_30,   BBBNames.P9_31,
            BBBNames.P8_3, BBBNames.P8_4,  BBBNames.P8_5,  BBBNames.P8_6, BBBNames.P8_20,BBBNames.P8_19,
            BBBNames.P9_11, BBBNames.P9_12, BBBNames.P9_13  ,BBBNames.P8_22,BBBNames.P8_23, BBBNames.P8_24, BBBNames.P8_21,    BBBNames.P8_25, BBBNames.P8_27, BBBNames.P8_28,
            BBBNames.P8_29, BBBNames.P8_30,BBBNames.P8_31,BBBNames.P8_32,BBBNames.P8_34

           // BBBNames.P9_41, BBBNames.P9_42 /// ,  BBBNames.P9_29,BBBNames.P9_25, P9_27 kai P9_30 mporei na einai energa
    };

//    final  String[]  inputString= {
//            BBBNames.P8_33,BBBNames.P8_35, BBBNames.P8_36, BBBNames.P8_37, BBBNames.P8_38, BBBNames.P8_39,BBBNames.P8_40,
//            BBBNames.P8_3, BBBNames.P8_4,  BBBNames.P8_5,  BBBNames.P8_6,  BBBNames.P8_7,  BBBNames.P8_9,  BBBNames.P8_8,
//            BBBNames.P8_10,BBBNames.P8_11, BBBNames.P8_20,BBBNames.P8_14, BBBNames.P8_15,  BBBNames.P8_16, BBBNames.P8_17,
//            BBBNames.P9_11, BBBNames.P9_12, BBBNames.P9_13  ,BBBNames.P8_22,BBBNames.P8_23, BBBNames.P8_24,BBBNames.P8_12,
//            BBBNames.P8_18, BBBNames.P8_21,    BBBNames.P8_25,BBBNames.P8_26,
//    };
//    final  String[] outputString = {
//            BBBNames.P8_13,BBBNames.P8_19,BBBNames.P8_27,  BBBNames.P8_28,  BBBNames.P8_29,  BBBNames.P8_30,  BBBNames.P8_31,
//            BBBNames.P8_32,   BBBNames.P8_34,  BBBNames.P8_41, BBBNames.P8_42, BBBNames.P8_43, BBBNames.P8_44, BBBNames.P8_45,  BBBNames.P8_46,
//            BBBNames.P9_14, BBBNames.P9_15,BBBNames.P9_16, BBBNames.P9_17, BBBNames.P9_18, BBBNames.P9_19,
//            BBBNames.P9_20,  BBBNames.P9_21,  BBBNames.P9_22, BBBNames.P9_23,  BBBNames.P9_25, BBBNames.P9_27,
//            BBBNames.P9_28,  BBBNames.P9_29,BBBNames.P9_30,   BBBNames.P9_31,
//            BBBNames.P9_41, BBBNames.P9_42 ///P9_27 kai P9_30 mporei na einai energa
//    };
    ...
    protected ArrayList<String>[] outputCommands = new ArrayList[outputString.length];
    //    private ArrayList<DigitalInput>[] inputButtons = new ArrayList[inputString.length];
    private DigitalOutput pins[] = new DigitalOutput[outputString.length];
    ...
    public SH() {
        ...
        initGpioPinDigitalOutputs(board);
    ...
    private void initGpioPinDigitalOutputs(Board board) {

        for (int i = 0; i < outputString.length; i++) {
            try {
                DigitalOutput pin = null;
                pin = board.getPin(outputString[i]).as(DigitalOutput.class);
                pin.low();
                pins[i] = pin;
                System.out.println("initialized output no " + i + "  - " + outputString[i]);
            }catch (Exception e){
                System.out.println("ERROR output" + outputString[i]);
...
//
        ...
        for (int i = 0; i < inputString.length; i++) {
            try {
                Gpio myButton = null;
                myButton =  gpioBridge.getGpio(inputString[i], Direction.IN);


                gpioBridge.register(myButton,new GpioUsageExampleListener2(i,gpioBridge) );

            }catch (Exception e){
                System.out.println("ERROR input" + inputString[i]);
...
//    private void initInputListeners(Board board) {
////    GpioPinDigitalInput myButton = gpio.provisionDigitalInputPin(RaspiPin.GPIO_02,             // PIN NUMBER
////                                                                     "MyButton",                   // PIN FRIENDLY NAME (optional)
////
//        for (int i = 0; i <= inputString.length; i++) {
//            try {
//                DigitalInput myButton = null;
//                myButton = board.getPin(inputString[i]).as(DigitalInput.class);
//
//                Button button = new Button(myButton, Signal.Low);
//                //Add a button listener
//                button.addListener(new GpioUsageExampleListener(i));
//                System.out.println("initialized input no "+i);
...
//            }catch (Exception e){
//                System.out.println("ERROR input" + outputString[i]);
//
//
//            }
//        }
////gpio.shutdown();
//    }
    public class GpioUsageExampleListener2 implements GpioSignalListener {
        ...
        public GpioUsageExampleListener2(int id,GpioBridge gpioBridge) {
            System.out.println(" id " + id);
            this.id = id;
            this.gpioBridge=gpioBridge;
            ...
            for (int i = 0; i < outputPowerCommands.length; i++) {
                ...
                for (int j = 0; j < activatePortOnCommand[i].size(); j++) {
                    ...
                    if (pin == null) {
                        ...
                        initGpioPinDigitalOutputs(board);
                        board.shutdown();                        pin = pins[activatePortOnCommand[i].get(j)];
                    }
                    if (pin == null) {
                        continue;
                    }
...
//        // release the GPIO controller resources
    ...
    public class GpioUsageExampleListener implements ButtonListener {
    ...
    private DigitalOutput getPinFromOutput(int output) {
        DigitalOutput p = null;
