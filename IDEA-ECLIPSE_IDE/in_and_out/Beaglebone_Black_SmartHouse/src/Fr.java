...
public class Fr extends JFrame
{
    ...
    public Fr(SH sh)
    {
        ...
        ImageIcon timelIcon=new ImageIcon(SH.contentPath+"time.png");
        ...
        ImageIcon automationIcon=new ImageIcon(SH.contentPath+"automation.png");
