...
public class Jarvis {
    ...
    private String musicFilesLocation = SH.contentPath+"Music";
    public static final String GeoCiyyLocation = SH.contentPath+"resources/location/GeoLiteCity.dat";
    private final String findMobileScr = SH.contentPath+"resources/FindMobile.jar";
    ...
    public String dospeak(String speaktext) {
        try {
            ...
            speechProcess = Runtime.getRuntime().exec(new String[]{"pico2wave", "-w", SH.contentPath+"lookdave.wav", '\"' + speaktext + '\"'});
                ...
                public void run() {
                    try {
                        ...
                        if (!speechProcess.isAlive()) {
                            speakWProcess = Runtime.getRuntime().exec("play "+SH.contentPath+"lookdave.wav");
                        }
    ...
    private void googleStoreSpeech(String text) throws IOException{
        ...
        FileOutputStream outStream=new FileOutputStream(SH.contentPath+"lookdave.wav");
        int read=0;
