/**
 * Created by tsoglani on 9/12/2016.
 */
...
public class BeagleBone extends AbstractBoard implements FeatureActivationListener {
...
//        }
    ...
    private void createInputs(){
        ...
        getInPins().add(new BeagleBonePin("J1_1", "UART01", 0, 0, "J1", 1));
        getInPins().add(new BeagleBonePin("J1_2", "UART01", 0, 0, "J1", 2));
        getInPins().add(new BeagleBonePin("J1_3", "UART01", 0, 0, "J1", 3));
        getInPins().add(new BeagleBonePin("J1_4", "UART01", 0, 0, "J1", 4));
        getInPins().add(new BeagleBonePin("J1_5", "UART01", 0, 0, "J1", 5));
        getInPins().add(new BeagleBonePin("J1_6", "UART01", 0, 0, "J1", 6));
        getInPins().add(createAnalogInputPin("P9_33", "AIN4", 2, 7, "P9", 33, 4));
        getInPins().add(createAnalogInputPin("P9_35", "AIN6", 2, 9, "P9", 35, 6));
        getInPins().add(createAnalogInputPin("P9_36", "AIN5", 2, 8, "P9", 36, 5));
        getInPins().add(createAnalogInputPin("P9_37", "AIN2", 2, 5, "P9", 37, 2));
        getInPins().add(createAnalogInputPin("P9_38", "AIN3", 2, 6, "P9", 38, 3));
        getInPins().add(createAnalogInputPin("P9_39", "AIN0", 2, 3, "P9", 39, 0));
        getInPins().add(createAnalogInputPin("P9_40", "AIN1", 2, 4, "P9", 40, 1));
        getInPins().add(createNativeDigitalIOPin("P9_16", "EHRPWM1B", 1, 19, "P9", 16));
        getInPins().add(createNativeDigitalIOPin("P9_17", "GPIO0_5", 0, 5, "P9", 17));
        getInPins().add(createNativeDigitalIOPin("P9_18", "GPIO0_4", 0, 4, "P9", 18));
        getInPins().add(createNativeDigitalIOPin("P9_19", "GPIO0_15", 0, 15, "P9", 19));
        getInPins().add(createNativeDigitalIOPin("P9_41", "GPIO0_20", 0, 20, "P9", 41));
        getInPins().add(createNativeDigitalIOPin("P9_42", "GPIO0_7", 0, 7, "P9", 42));
        getInPins().add(createNativeDigitalIOPin("P9_20", "GPIO0_14", 0, 14, "P9", 20));
        getInPins().add(createNativeDigitalIOPin("P9_21", "UART2TX", 0, 3, "P9", 21));
        getInPins().add(createNativeDigitalIOPin("P9_22", "UART2RX", 0, 2, "P9", 22));
        getInPins().add(createNativeDigitalIOPin("P9_23", "GPIO1_17", 1, 17, "P9", 23));
        getInPins().add(createNativeDigitalIOPin("P9_24", "UART1TX", 0, 12, "P9", 24));
        getInPins().add(createNativeDigitalIOPin("P9_25", "GPIO3_21", 3, 21, "P9", 25));
        getInPins().add(createNativeDigitalIOPin("P9_26", "UART1RX", 0, 13, "P9", 26));
        getInPins().add(createSysFsDigitalIOPin("P9_27", "GPIO3_19", 3, 19, "P9", 27));
        getInPins().add(createNativeDigitalIOPin("P9_28", "GPIO3_17", 3, 17, "P9", 28));
        getInPins().add(createNativeDigitalIOPin("P9_29", "GPIO3_15", 3, 15, "P9", 29));
        getInPins().add(createSysFsDigitalIOPin("P9_30", "GPIO3_16", 3, 16, "P9", 30));
        getInPins().add(createNativeDigitalIOPin("P9_31", "EHRPWM0A", 3, 14, "P9", 31));
    }
    ...
    private List<Pin> inPins = new ArrayList();
