...
{ private JButton back;
    ...
    public SheduleView(Fr fr)
    {
        ...
        fr.isOnMainMenu=false;
         ...
         backTime=new ImageIcon(SH.contentPath+"back.png");
        ...
        fr.shv=this;
        addSchedule=new ImageIcon(SH.contentPath+"add_calentar.png");
